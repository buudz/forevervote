  ...
  return <section id="about" className="about-section" aria-labelledby="about-title">
    <div className="wrap about-grid">
      ...
      <div className="about-panel">
        ...
        <p>Voting uses Battle.net sign-in and a verified Classic WoW profile. Each eligible Battle.net identity gets one vote per poll, and changing your mind updates that vote rather than creating another.</p>
