...
const polls = [
  ...
  { id: "world-buffs", category: "World", title: "Should World Buffs be usable in raids?", context: "Keep the preparation ritual, or leave the buffs outside the raid?" },
  ...
  { id: "transmog", category: "QoL", title: "Should transmog exist in Forever?", context: "Choose your own look, or let equipment tell your character's story?" },
...
const categories = ["All", "PvP", "Raids", "Classes", "World", "QoL", "General"];
...
export default function Home() {
  ...
  return <>
    ...
    <header className="header wrap">
      <a className="brand" href="/" aria-label="VoteForever home"><span className="brand-mark" aria-hidden="true">V</span>VOTE<span className="gold">FOREVER</span></a>
    ...
    <main id="main">
      <section className="hero wrap">
        ...
        <p className="intro">What should change in World of Warcraft?<br />A home for player proposals. Built around verified WoW players.</p>
        <div className="hero-actions"><a className="button primary" href="#polls">Explore launch proposals <span aria-hidden="true">↓</span></a><a className="button secondary" href="#how-it-works">How it will work</a></div>
      ...
      <div className="wrap">
        <section className="principles" aria-label="Project principles">
          <div><span className="gold">01</span><p>Real player voices<small>Planned Battle.net + WoW profile verification</small></p></div>
        ...
        <section id="polls" className="polls-section">
          <div className="section-heading"><div><p className="eyebrow">THE CONVERSATION STARTS HERE</p><h2>Questions worth asking.</h2></div><span className="preview-label">8 PROPOSED LAUNCH POLLS</span></div>
          <p className="section-description">A first set of community questions, not statements of confirmed game features. No votes have been collected.</p>
    ...
    <footer className="footer wrap"><span className="footer-brand">VOTE<span className="gold">FOREVER</span></span><p>Independent World of Warcraft community project.<br />Not affiliated with or endorsed by Blizzard Entertainment.</p><a href="#main">Back to top ↑</a></footer>
  </>;
}
